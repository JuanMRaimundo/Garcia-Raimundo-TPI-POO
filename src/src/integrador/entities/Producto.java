...
public class Producto extends Base {
    ...
    //planteamos realción N:1 con Categoría
    ...
    public String toString() {
        return String.format("Producto [ID: %d | %s | $%.2f | Stock: %d | Categoria: %s]", 
                             getId(), getNombre(), getPrecio(), getStock(), categoria.getNombre());
    }
}
